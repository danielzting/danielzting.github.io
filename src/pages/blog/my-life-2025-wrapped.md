...
title: My Life 2025 Wrapped
summary: A blatant ripoff of Spotify Wrapped but for my entire life, and my goals for 2026.
date: 2025-12-31
---

So it's been a long time, but I have been inspired to post again by my friends who started a blogging circle. If you've been here before you'll notice the design looks completely different. This is because when I opened up my previous site in my editor, I realized I would have to install Ruby on my new laptop since I forked it from a [Jekyll theme](https://github.com/ronv/ultra). So instead of spending a couple minutes to set up a Jekyll toolchain, why not spend several weeks rewriting the whole thing in the shiny new hipster JavaScript framework *du jour*?

I eventually narrowed it down to [Eleventy](https://www.11ty.dev/) and [Astro](https://astro.build/) and went with Astro because their docs looked prettier. Overall it was a great developer experience and I took this opportunity to do an Evangelion-themed redesign. Before you get the wrong idea, mandatory disclaimer that I don't watch anime, except for when my friend forced me to watch Attack on Titan. That was good. I just am really fascinated by futuristic user interfaces.
