...
For each level, you'll see its name and the in-game name of the player who published it. I also linked a YouTube video so you can see what it looks like if you want and added some of my own commentary about the level's significance. Finally, there is the difficulty value. The source of the values is from [The Difficulty of Geometry Dash, Visualized](https://www.youtube.com/watch?v=4ktwuBGLCbM). It is derived by comparing the relative difficulty of two levels, where if completing level A is equivalent to reaching 80% on level B, then level B is 1/0.8 = 1.25 times harder than level A. By averaging the opinions of pro players, we can set the easiest level to a value of 1 and calculate up from there.
...
You will also see comparisons to other games. These are from [How Hard Geometry Dash Actually is (Full Analysis) | Mdog5](https://www.youtube.com/watch?v=bvmWzjO53YA) as I have not played other games seriously enough to judge their relative difficulty myself. So let's get started with the first official level.

[If you are more of a visual learner, I also made this post into a graph!](https://danielzting.github.io/gd-difficulty-visualization/)

### Stereo Madness by RobTop
*Difficulty value: 1.0.* ([YouTube](https://www.youtube.com/watch?v=E5L083YQzVE))
...
### Polargeist by RobTop
*Difficulty value: 1.7*. ([YouTube](https://www.youtube.com/watch?v=jKlSuCTxa3I))

This is the third level of the game and has the next rating of Normal.

### Cant Let Go by RobTop
*Difficulty value: 4.8*. ([YouTube](https://www.youtube.com/watch?v=nTlOljFl3Bw))
...
### Time Machine by RobTop
*Difficulty value: 7.0*. ([YouTube](https://www.youtube.com/watch?v=AoLMZGV1SgM))

This is the eighth level of the game, having the next difficulty of Harder.

### Clutterfunk by RobTop
*Difficulty value: 13*. ([YouTube](https://www.youtube.com/watch?v=cOU2MOXxPSE))
...
### Clubstep by RobTop
*Difficulty value: 21*. ([YouTube](https://www.youtube.com/watch?v=gok5ShDXxg4))
...
*Difficulty value: 34*. ([YouTube](https://www.youtube.com/watch?v=I3LFTGTIWoI))
...
### B by motleyorc
*Difficulty value: 56*. ([YouTube](https://www.youtube.com/watch?v=ohKPqGxotao), [GDBrowser](https://gdbrowser.com/34085027))

This marks the entry point into medium demons and is also the first custom level on this list. Medium demon is the hardest difficulty I have beaten on mobile before switching to the Steam version. The official levels made by the developer of GD, RobTop, are considered to be easy demons. From here on out, all the levels are made by the community.[^1] I have linked them in GDBrowser if you want to try them out in-game.

### Nine Circles by Zobros
*Difficulty value: 95*. ([YouTube](https://www.youtube.com/watch?v=dOdPoU1ncOc), [GDBrowser](https://gdbrowser.com/4284013))
...
### Rupture by Jekko
*Difficulty value: 310*. ([YouTube](https://www.youtube.com/watch?v=kNDpLgaQQqk), [GDBrowser](https://gdbrowser.com/10505306))

This is the first insane demon on this list. All the levels I have beaten of this difficulty or higher have been on 120hz. One sign that a game has a high skill ceiling is the usefulness of high refresh rates. I myself noticed an instant marked improvement when I bought my first high refresh rate monitor, going from a hardest of hard demon to extreme demon in a couple of months. See how [top player Doggie says](https://docs.google.com/document/d/1U4dgYnJZScCF8LO-5lRDQB3s2SiWSKJsCH-o3YiNXQA) there is even a noticeable difference going from 240hz to 360hz:
...
### Red World by saRy
*Difficulty value: 1,600*. ([YouTube](https://www.youtube.com/watch?v=ZH8iubNQBXE), [GDBrowser](https://gdbrowser.com/2374518))

This is the entry point into extreme demons, the highest tier of the highest difficulty in GD. Out of the millions of people that have paid for the full version of the game, I estimate the number of people that have beaten to be an extreme demon to be no more than ten thousand[^2], or less than 1% of the active playerbase. If you count the over half a billion people that have downloaded the free version, that puts an extreme demon victor in the top 0.01% or one in ten thousand players. This is rarer than achieving the highest rank in many esports games such as [Challenger in League of Legends at 0.016%](https://www.leagueofgraphs.com/rankings/rank-distribution), [Radiant in Valorant at 0.05%](https://www.vstats.gg/ranks), and [Supersonic Legend in Rocket League at 0.02%](https://rocketleague.tracker.network/rocket-league/distribution) with respect to percentiles.[^3] The crazy thing is, we have barely begun in terms of true difficulty.

### Cataclysm by Ggb0y
*Difficulty value: 2,700*. ([YouTube](https://www.youtube.com/watch?v=J90L73YOR3k), [GDBrowser](https://gdbrowser.com/3979721))

From here on out, GDBrowser will show the level's position on the [Geometry Dash demonlist](https://pointercrate.com/demonlist/), which is a ranking of the top 150 hardest levels in the game by the consensus of top players. The next couple of levels are in the legacy list, which means that they were formerly in the top 150 but got pushed off over time as harder levels came out. At time of writing, GDBrowser shows Cataclysm in the 500s, though be aware that positions lower than #150 are not actively validated by the demonlist team and are approximate. As harder levels come out, every levels's ranking will eventually fall, which is why there are so many "at time of writing" and "currently" qualifiers in this post.
...
### Bloodbath by Riot
*Difficulty value: 5,700*. ([YouTube](https://www.youtube.com/watch?v=twTw4fjT0ik), [GDBrowser](https://gdbrowser.com/10565740))
...
I currently have 75% on it with over 20000 attempts, and it is I an many players' ultimate milestone goal. Yet, for truly dedicated players, it has simply become a rite of passage; a stepping stone; the gateway to high level play. This was the top 1 hardest level when I first started playing, but now, top players can beat this level on their first try as easily as I can beat easy demons with my current skill level. Another insane fact is that as legitimately hard Bloodbath is, it is closer to Stereo Madness in terms of difficulty than current top levels, as we will later see.

### Black Blizzard by KrmaL
*Difficulty value: 15,000*. ([YouTube](https://www.youtube.com/watch?v=lsT5TjQ1Ubc), [GDBrowser](https://gdbrowser.com/34057654))
...
### Sonic Wave by lSunix
*Difficulty value: 42,000*. ([YouTube](https://www.youtube.com/watch?v=GpXTwPgweAk), [GDBrowser](https://gdbrowser.com/26681070))
...
*Difficulty value: 94,000*. ([YouTube](https://www.youtube.com/watch?v=5SzKetF2btw), [GDBrowser](https://gdbrowser.com/42584142))
...
*Difficulty value: 130,000*. ([YouTube](https://www.youtube.com/watch?v=fhmgZYCJ29M), [GDBrowser](https://gdbrowser.com/57571983))
...
### Kenos by npesta
*Difficulty value: 260,000*. ([YouTube](https://www.youtube.com/watch?v=Bs1kVySdUtI), [GDBrowser](https://gdbrowser.com/58673581))

You probably have seen npesta's [hyperventilating scream](https://www.reddit.com/r/okbuddyretard/comments/euvcsw/black_emoji_world_record/) when it went viral as a reaction clip, but you might not know what he was actually reacting to: his verification of Kenos. His apparent breakdown was due to many unlucky deaths near the end of the level, forcing him to spend a six-digit number of attempts and 117 streams finally reach 100%.
...
*Difficulty value: 510,000*. ([YouTube](https://www.youtube.com/watch?v=wpS5PSHmji0), [GDBrowser](https://gdbrowser.com/60978746))

This is currently the transition into the main list, which is the top 75 hardest levels in the game. Unlike the extended list where only completions give list points, a player with significant progress on a main list demon can submit a partial run and receive points.

### The Plunge by Dolabill
*Difficulty value: 900,000*. ([YouTube](https://www.youtube.com/watch?v=8gW1-_u1K0Y), [GDBrowser](https://gdbrowser.com/113220284))

This is currently the transition to the top 50.

### poocubed by Liisp
*Difficulty value: 2,000,000*. ([YouTube](https://www.youtube.com/watch?v=3WXkiqmkESA), [GDBrowser](https://gdbrowser.com/85133223))

This is not the only top level with a goofy name. Other examples include "Dry Out Copyable 2", "limbo but uwu ig idk", and a whole series named after Breaking Bad characters. All of those are verbatim real names of extreme demons. It just goes to show how much Bloodbath, an already hard level, former top 1, and many players' career goal, is eclipsed when there are joke levels hundreds of spots above it.

### Sakupen Circles by TheDiamondPizza
*Difficulty value: 3,500,000*. ([YouTube](https://www.youtube.com/watch?v=ofG2mJi9kEA), [GDBrowser](https://gdbrowser.com/76962930))

This is currently the transition to the top 25.

### Slaughterhouse by IcEDCave
*Difficulty value: 4,100,000*. ([YouTube](https://www.youtube.com/watch?v=kpcF1-QAHQc), [GDBrowser](https://gdbrowser.com/27690100))

Slaughterhouse may be the most recognizable top level outside of the GD community, with the showcase video having 30+ million views and [xQc](https://www.youtube.com/watch?v=Gx8FrfKhn70) and other streamers having done reactions on it. Even though it has dropped all the way down to #20, it is considered to be one of the best showcases of difficulty to non-GD players, owing to its dark music, hellish visuals, and ultra-fast gameplay.

### Anathema by nikroplays
*Difficulty value: 8,900,000*. ([YouTube](https://www.youtube.com/watch?v=_uKwmjHmySI), [GDBrowser](https://gdbrowser.com/112313819))

This is currently the transition to the top 10.

### Tidal Wave by OniLinkGD
*Difficulty value: 19,000,000*. ([YouTube](https://www.youtube.com/watch?v=9fsZ014qB3s), [GDBrowser](https://gdbrowser.com/86407629))
...
*Difficulty value: 37,000,000*. ([YouTube](https://www.youtube.com/watch?v=CELNmHwln_c), [GDBrowser](https://gdbrowser.com/119544028))
...
Let's review the claim that Bloodbath is closer to Stereo Madness than the hardest level in the game: Bloodbath has about 5000 times the difficulty value of Stereo Madness on our chart. 5000 times Bloodbath would be in the range of 25 million, and Thinking Space II is sitting at 37 million. So indeed, Bloodbath, a level that the vast majority of players can only dream of beating, is closer to the easiest level in the game than the hardest level in the game.

### Aeternus by Riot
*Difficulty value: 190,000,000*. ([YouTube](https://www.youtube.com/watch?v=WIjuyPd3kck), [GDBrowser](https://gdbrowser.com/102647436))
...
### Mental game
Top players need to have a special kind of mental toughness to break through mindblocks, since it's impossible to avoid them completely. Perhaps the best example of this is Doggie's ongoing verification of [GRIEF](https://www.youtube.com/watch?v=bQXnREyaO34), a contender to take the top 1 spot once it is verified. Doggie started practicing the level in May 2024. He reached 80% with 207K attempts on his 134th stream in November. Some expected the end to be near. But severe mindblocks caused him to lose consistency in the middle of the level. It would take almost an entire year to break the mindblock and get a new best of 83% on stream #286 in November 2025, well into the 300,000s in attempt count.

### "Compound interest"
In other competitive games that have been around as long as or longer than GD, the best players only have to get better than the other top players around their level to stay at the top. But throughout all twelve years of GD's history, players have created top 1 levels that shattered the previous skill ceiling to heights never seen before, a recent example being Tidal Wave doubling the record for frame perfect count. Each top 1 being 20%, 50%, or double the difficulty of the last "compounds" the growth of the skill ceiling exponentially in a unique way compared to just improving against human opponents.

It is for this reason I believe the skill ceiling of Geometry Dash has possibly increased the most out of any video game in existence. The other contenders I can see having this title are globally popular esports games (League of Legends, Dota 2, Rocket League, etc.) and single-player games that allow users to create their own arbitrarily hard levels (osu!, Mario Maker). This is not considering pretty much every game in real life like chess or tennis which probably blow all video games out of the water just from the fact that it's basically impossible to become a pro if you don't start as a child.
...
[^1]: The ingenuity of the community is the reason why the game was able to survive almost seven years with no updates. This post is about difficulty, but I could write a whole other essay about the talent creators have with the level editor, whether for their [artistic brilliance](https://www.youtube.com/watch?v=2O8EKrXsKlo), managing to make [3D graphics in a 2D game](https://www.youtube.com/watch?v=xu1wRfUHtKg), or [recreating a whole other game](https://www.youtube.com/watch?v=a2aOWkWgc34).

[^2]: Another function of the demonlist is to record who completed the levels on the list, until the level falls out of the top 150. The [entry for Cataclysm](https://pointercrate.com/demonlist/permalink/142/) shows 720 completions, and Cataclysm was pushed into the legacy list in 2019. As Cataclysm is one of the first extremes people tackle, I argue we can reasonably assume the number of Cataclysm victors, which should be close to the number of extreme demon victors, has increased by no more than 2-10x in the six years since Cataclysm completions stopped being recorded. This is the basis for my estimate of there being less than 10,000 extreme demon victors worldwide.

[^3]: This is not to say beating an extreme demon is as hard as achieving the highest rank in one of these games. These top ranks can be just a couple hundred to thousand players in size, which is likely less than the number of extreme demon victors. Moreover, only a small fraction of GD players play to seriously improve. One could argue that since more people have tried GD, the "genetic pool" is larger, but we could also argue that the average esports player is much more motivated to improve than the average GD player, making the esports talent pool higher quality.
